...
Но ограничения по глубине все равно остается, т.к. если использовать мультиязычный вариант (даже простое 2-х язычное меню - русский+английский), то ошибка 552 снова возникает, теперь для английской ветки сайта (/public/en/tags/teacher/page/1.html). Даже с `uglyURLs: true` глубина вложенности для страниц пагинации составляет 5 уровней (папки en, tags, teacher, page + файл 1.html), что превышает лимит narod.ru. 
